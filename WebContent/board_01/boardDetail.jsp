...
List<BoardDTO> detaillist = (List<BoardDTO>)request.getAttribute("marketdetail");
...
<link href="https://fonts.googleapis.com/css2?family=Anton&display=swap"
	rel="stylesheet">
<link rel="stylesheet" type="text/css" href="boardDetailcss.css">
<script src="https://code.jquery.com/jquery-3.6.0.js"
	integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk="
	crossorigin="anonymous"></script>

<script src="boardDetailjs.js">
	...
	<form >
		<div class="wrap">
			...
			<section>
				...
				%>	
					<div class="detailpic">
						<img src = "../boardUpload/<%=detaillist.get(i).getMktbdimg()%>">
					</div>
					<div class="userinfo">
						<div class="userpic">
						...
						<div class="userinfowrap">
							...
							<div class="postdate"><%=detaillist.get(i).getMktbddate()%></div>
						</div>
					</div>
