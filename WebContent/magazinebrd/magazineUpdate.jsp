...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../magazinebrd/magazineRegicss.css">
	<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
	<script type="text/javascript" src="../login/portloginjs.js"></script>

</head>
	<form action = "magaUpdate.do?comm=magazineUpdate" method="post">
	<div class="wrap">
		...
		<div class="headerbot">
			<div class="mainnav">
				<ul>
					...
					<li><a href="magazineView.jsp">MAGAZINE</a></li>
	...
	<section>
		...
		for(int i=0;i<magadetail.size();i++){
			...
			<div class = "magazineView">
				...
				<input type = "hidden" name = "magano" value = "<%=magadetail.get(i).getMagano()%>">
				<input type = "text" name = "magatitle" placeholder="제목을 입력하세요" required="required" value ="<%=magadetail.get(i).getMagatitle()%>">
			</div>
			<div class = "magazinecontent">
				<textarea placeholder="내용을 입력하세요" required="required" name = "magacon"><%=magadetail.get(i).getMagacon()%></textarea>
			</div>
			<div class = "subbtn">
