...
<%
	...
	List<PrivateInfoDTO> profilelist = mystylesrv.getPrivateInfo(user_id);
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="memberbrdcss.css">
	<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
	<script src="memberbrdjs.js"></script>
	...
	<section>
		<div class="brdwrap">
				...
				<div class="privateinfo">
					...
					<div class="profileinfo">
						...
						for(int j=0; j<profilelist.size(); j++){
							...
							<div class="idin"> <%=profilelist.get(j).getUser_id() %> </div>
							
							
							<div class="btnin">
							<%
							if(profilelist.get(j).getUser_id().equals(id)){
								%>
			...
			for(int i=0;i<profilelist.size();i++){
				...
				if(profilelist.get(i).getUser_id().equals(id)){
					%>
				...
				<div class="brdgallery">
					...
					<%
						for(int i=0;i<pbrdlist.size();i++){
							%>
							<li>
								<a href="PrivateBrdDetail.do?comm=privateBrdDetail&pbrdno=<%=pbrdlist.get(i).getPbrdno()%>"><img src="../privateBrdUpload/<%=pbrdlist.get(i).getPbrd_pic()%>"></a>
							</li>	
						<%							
						}
					%>
